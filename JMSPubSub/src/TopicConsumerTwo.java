...
public class TopicConsumerTwo implements MessageListener {
	public static final String TOPIC = "topic/PJPubSubTopic";

	public static void main(String[] args) throws JMSException,
	NamingException, InterruptedException {
		System.out.println("----Entering JMS TopicConsumerTwo----");
	...
	public void onMessage(Message msg) {
		try {
			System.out.println("Incoming msgs for TopicConsumer2: "
